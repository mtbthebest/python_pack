...
class Tokenizer:
    ...
    def init_moses(self, lang):
        self.moses_tokenizer = mosestokenizer.MosesTokenizer(lang['src'])
        self.moses_detokenizer = mosestokenizer.MosesDetokenizer(lang['tgt'])
    ...
    def tokenize(self, line):
        tokenized = self.moses_tokenizer.tokenize(line)
    ...
    def detokenize_moses(self, line):
        return self.moses_detokenizer(line.split())
